      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 bg-white rounded-3xl p-8 card-shadow">
          <div className="flex items-center gap-5">
            ...
            <div>
              <h3 className="text-2xl font-bold text-[#16213E] dark:text-[#F8F9FA]">Gift Cards</h3>
              <p className="text-[#6C757D] dark:text-gray-400 dark:text-gray-500 text-sm">The perfect gift for every occasion</p>
            </div>
          </div>
