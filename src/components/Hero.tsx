        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in-up">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <a
                href="#featured"
                className="inline-flex items-center px-8 py-3.5 rounded-full text-white font-semibold text-sm bg-[#E94560] hover:bg-[#d63851] transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-[#E94560]/30"
              >
                Shop Now
