        ...
        <div className="bg-white rounded-3xl max-w-md w-full p-8 animate-scale-in relative">
          ...
          {subscribed ? (
            <>
              ...
              <h3 className="text-2xl font-bold text-[#16213E] text-center mb-2">You&apos;re In!</h3>
              <p className="text-[#6C757D] text-sm text-center">Check your inbox for 20% off your first order.</p>
            </>
          ) : (
            <>
