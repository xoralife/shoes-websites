        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-full bg-[#E94560]/20 flex items-center justify-center">
              <Gift size={28} className="text-[#E94560] dark:text-[#FF6B6B]" />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-white">Bundle & Save</h3>
              <p className="text-gray-300 dark:text-gray-600 text-sm">Buy 2 pairs get 10% off. Buy 3 pairs get 20% off!</p>
            </div>
          </div>
