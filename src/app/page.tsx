        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          {["Men","Women","Kids","Sports"].map((name) => (
            <div key={name} className="flex flex-col items-center">
              <div className="w-36 h-36 md:w-44 md:h-44 rounded-full bg-gray-200 dark:bg-[#2D2D4A] animate-pulse" />
              <div className="mt-5 h-5 w-20 bg-gray-200 dark:bg-[#2D2D4A] rounded animate-pulse" />
            </div>
          ))}
        </div>
      </div>
