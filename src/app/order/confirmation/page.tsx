    ...
    <div className="min-h-screen bg-[#F8F9FA] dark:bg-[#0F0F1A]">
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-xl mx-auto px-4 text-center">
          ...
          <p className="text-[#6C757D] dark:text-gray-400 dark:text-gray-500 mb-2">Thank you for your purchase.</p>
          <p className="text-sm text-[#6C757D] dark:text-gray-400 dark:text-gray-500 mb-8">
          ...
          <div className="bg-white dark:bg-[#1A1A2E] rounded-2xl p-6 card-shadow mb-8 text-left">
            <h2 className="font-bold text-[#16213E] dark:text-[#F8F9FA] mb-4 flex items-center gap-2">
              <Package size={18} className="text-[#E94560] dark:text-[#FF6B6B]" /> Order Details
            </h2>
            <div className="space-y-2 text-sm text-[#6C757D] dark:text-gray-400 dark:text-gray-500">
              ...
              <div className="flex justify-between"><span>Status</span><span className="text-green-600 dark:text-green-400 font-medium">Confirmed</span></div>
          ...
          <p className="text-sm text-[#6C757D] dark:text-gray-400 dark:text-gray-500 mb-6">A confirmation email has been sent to your email address.</p>
