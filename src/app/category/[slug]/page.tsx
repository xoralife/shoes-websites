      ...
      <main className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-10">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-[#16213E] dark:text-[#F8F9FA] mt-1">{categoryName}&apos;s Collection</h1>
            <p className="text-[#6C757D] dark:text-gray-400 mt-2">{filtered.length} products found</p>
          </div>

          {filtered.length === 0 ? (
            <div className="text-center py-20">
              <h2 className="text-xl font-bold text-[#16213E] dark:text-[#F8F9FA] mb-2">No Products Found</h2>
              <p className="text-[#6C757D] dark:text-gray-400 mb-6">No products in this category yet.</p>
